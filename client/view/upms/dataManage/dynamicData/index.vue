<template>
  <div>
    <kindo-box title="条件筛选" icon="fa-search">
      <el-form v-model.trim="dataSearch" label-position="right" label-width="110px" inline @submit.native.prevent @keyup.enter.native="getCate">
    ...
    <kindo-box title="基础字典" icon="fa-area-chart">
