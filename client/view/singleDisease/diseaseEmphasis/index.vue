...
export default {
      ...
      bar: {
        tooltip: {
          ...
          formatter: (params, ticket, callback) => {
            let paramsObj = Object.assign({}, this.search, { bzName: params[0].name, bzlx: 1 })
  ...
  methods: {
    ...
    goTo(row) {
      ...
      kindo.cache.set('goBack', { from: '/9bd2caf7-24ac-423e-8892-f3a316a5abf2/70d49674-08de-4f97-892e-badaacc309b4', params: Object.assign({}, this.search, this.dateComb) }, 'session')
    }
  }
}
</script>