<template>
  <div>
    ...
    <kindo-box title="科室重点单病种统计" icon="fa fa-bar-chart">
      <!-- <div class="title">
    ...
    <kindo-box title="重点病种统计" icon="fas fa-list">
      <!-- <div class="title">
        <div class="title-control">
      ...
      <kindo-table :url="tableUrl" :queryParam="search" ref="table" width="100%" :pageSize="15" :default-sort="{prop:'blsl',order:'descending'}">
        ...
        <el-table-column prop="mzlx" label="麻醉类型" width="130px" header-align="center" align="right" :show-overflow-tooltip="true"></el-table-column>
...
export default {
      ...
      bar: {
        tooltip: {
          ...
          formatter: (params, ticket, callback) => {
            ...
            let paramsObj = Object.assign({}, this.search, { deptName: params[0].name, bzlx: 1 })
  ...
  created() {
    if (JSON.stringify(this.$route.query) !== '{}' && kindo.cache.get('goBack').tab === 'first') {
      // 一定会存在时间和科室的字段
  ...
  methods: {
    ...
    goTo(row) {
      ...
      kindo.cache.set('goBack', { from: '/9bd2caf7-24ac-423e-8892-f3a316a5abf2/6c763bfb-10ca-4969-8101-c3d584a27933', tab: 'first', params: Object.assign({}, this.search, this.dateComb) }, 'session')
    }
  }
}
</script>