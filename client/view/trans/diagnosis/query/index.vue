  ...
  <div>
    <kindo-box>
      <el-form inline :model="form" :rules="rules" ref="Model" onsubmit="return false;" @keyup.enter.native="get">
        <el-form-item prop="name">
          <el-tooltip effect="dark" content="请输入医院诊断术语编码或名称" placement="top">
            <el-input v-model="form.name" placeholder="医院诊断术语..." style="width:185px;"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item prop="standardName">
          <el-tooltip effect="dark" content="请输入标准诊断术语编码或名称" placement="top">
            <el-input v-model="form.standardName" placeholder="标准诊断术语..." style="width:185px;"></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item>
    ...
    <kindo-box>
      <kindo-table :url="tableApi" ref="table" :queryParam="form">
        <el-table-column prop="hosCode" label="医院诊断术语编码" width="130" align="left" sortable="custom" show-overflow-tooltip> </el-table-column>
        <el-table-column prop="name" label="医院诊断术语名称" width="300" align="left" sortable="custom" show-overflow-tooltip> </el-table-column>
        <el-table-column prop="standardCode" label="标准诊断术语编码" width="130" align="left" sortable="custom" show-overflow-tooltip> </el-table-column>
        <el-table-column prop="standardName" label="标准诊断术语名称" width="300" align="left" sortable="custom" show-overflow-tooltip> </el-table-column>
