<template>
  <div>
    <kindo-box title="用户修改" icon="fa-area-chart">
      <el-form :model="model" :rules="rules" ref="form" label-width="110px" style="width: 275px;">
        ...
        <el-form-item label=" ">
          <el-button icon="edit" type="primary" v-disabled="'other'" @click="save">保存</el-button>
        </el-form-item>
      </el-form>
    </kindo-box>
  </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        age: [{ pattern: kindo.validate.pattern.number, message: '年龄必须为数字值', trigger: 'change' }],
